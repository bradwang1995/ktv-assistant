...
| IT-03 | P0 | Home page | Make portrait mobile home layout clearly show `创建房间` and `扫码点歌`, while making intro panels look non-clickable. | Planned |
...
| IT-07 | P0 | Search preview | Only one preview may play at once; clicking preview/card selects the result. | Planned |
